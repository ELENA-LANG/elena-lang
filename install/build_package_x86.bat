...
copy %~dp0\..\bin\elena-ide.exe %~dp0\output\bin
...
move %~dp0..\dat\og\bt_rules60.dat %~dp0\output\bin\
move %~dp0..\dat\og\bc_rules60.dat %~dp0\output\bin\
...
copy %~dp0\..\examples60\rosetta\twentyfour\*.l %~dp0\output\examples60\rosetta\twentyfour
