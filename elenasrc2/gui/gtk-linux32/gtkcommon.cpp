...
{
   return ((Window*)data)->onClose() ? TRUE : FALSE;
}
...
void Control :: setCaption(const TCHAR* caption)
{
...
void Clipboard :: settext(const TCHAR* text)
{
...
void Clipboard :: freetext(TCHAR* text)
{
   g_free(text);
}
*/