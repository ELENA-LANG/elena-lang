...
public:
   ...
   virtual void injectEmbeddableGetAt(SNode assignNode, SNode callNode, ref_t subject) = 0;
...
public:
   ...
   virtual bool optimizeEmbeddableGetAt(_CompilerScope& scope, _Compiler& compiler, SNode node) = 0;
};
