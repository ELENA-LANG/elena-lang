...
//   const int elDebugDPTR           = 0x000F0000;
  ...
  // --- Project warning levels
   ...
   #define ELENA_SIGNITURE          "ELENA.4."       // the stand alone image
   #define ELENACLIENT_SIGNITURE    "VM.ELENA.4."    // the ELENAVM client

   #define MODULE_SIGNATURE         "ELENA.4.1"      // the module version
