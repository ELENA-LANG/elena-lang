...
//   #define ELENA_ERR_OUTOF_MEMORY  0x190
  ...
  // --- Project warning levels
   ...
   constexpr auto ELENA_SIGNITURE         = "ELENA.12.";      // the stand alone image
   constexpr auto ELENACLIENT_SIGNITURE   = "VM.ELENA.12.";   // the ELENAVM client

   constexpr auto MODULE_SIGNATURE        = "ELENA.12.0";     // the module version
