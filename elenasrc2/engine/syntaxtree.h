...
//   lxSubMessage               = 0x021200,
   lxExpression               = 0x811210,
   lxSeqExpression            = 0x811211,
   lxNil                      = /*0x018040*/0x10220,
   lxResult                   = /*0x0180C0*/0x10230,   // arg - offset
   lxMessageOp                = 0x411230,
   lxMessageExpression        = 0x011230,
