...
//   lxInvalid                  = -2,
   ...
   lxCalling_0                = 0x0280A0,
   lxCalling_1                = 0x0280A1,
   lxCurrent                  = 0x0080B0, // arg -offset
   lxResult                   = 0x0080C0, // arg -offset
   lxNewFrame                 = 0x0200D0,   // if argument -1 - than with presaved message
   lxCreatingClass            = 0x0280E0,   // arg - count
   lxCreatingStruct           = 0x0280F0,   // arg - size

   // attributes
   lxAttribute                = 0x00F00,
   lxNameAttr                 = 0x00F01,
   lxSourcePath               = 0x00F02,
   lxCol                      = 0x00F03,
   lxRow                      = 0x00F04,
   lxLength                   = 0x00F05,
   lxBreakpoint               = 0x00F06,
   lxAutogenerated            = 0x00F07,
   lxArgCount                 = 0x00F08,
   lxType                     = 0x00F09,  // arg - reference
   lxClassFlag                = 0x00F0A, // class fields
