...
void (*commands[0x100])(int opcode, x86JITScope& scope) =
{
   ...
   &compileNot, &compileNop, &compileNop, &loadOneByteOp, &compileNop, &loadOneByteLOp, &loadOneByteOp, &compileQuit,
   ...
   &loadOneByteLOp, &loadOneByteLOp, &loadOneByteOp, &loadOneByteLOp, &compileNop, &compileNop, &loadOneByteLOp, &compileNop,
