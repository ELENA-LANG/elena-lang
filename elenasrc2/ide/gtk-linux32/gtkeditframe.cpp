...
EditFrame :: EditFrame(SDIWindow* owner)
   : TabBar()
{
//   _owner = owner;
//   _currentDoc = NULL;
...
void EditFrame :: addDocumentTab(const _text_t* name, Document* document)
{
...
//   textView->applySettings(Settings::tabSize, Settings::tabCharUsing, Settings::lineNumberVisible, Settings::highlightSyntax);
   textView->setStyles(STYLE_MAX + 1, defaultStyles, 15, 20);
...
const _text_t* EditFrame :: getDocumentName(int index)
{
