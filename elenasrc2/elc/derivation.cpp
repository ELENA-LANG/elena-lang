...
ref_t DerivationTransformer :: generateTemplate(SyntaxTree& templateTree, _CompilerScope& scope, ref_t reference, List<ref_t>& parameters)
{
   DerivationScope templateScope(&scope, NULL, NULL, NULL);
   templateScope.templateRef = reference;
   templateScope.autogeneratedTree = &templateTree;
