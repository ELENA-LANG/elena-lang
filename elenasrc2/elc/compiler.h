...
//   void compileLoop(SyntaxWriter& writer, SNode node, CodeScope& scope);
   ...
   void declareArgumentList(SNode node, MethodScope& scope, bool withoutWeakMessages);
...
//   void compilePreloadedCode(_CompilerScope& scope, SNode node);
   ...
   void compileVMT(SyntaxWriter& writer, SNode node, ClassScope& scope, bool ignoreAutogenerated = false);
