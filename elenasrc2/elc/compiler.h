...
//      bool loadAttributes(_Module* module);
      ...
      void loadExtensions(ident_t ns, ident_t subns)
      {
         ...
         loadExtensions(fullName.c_str(), dummy);
      }
...
//      }
      void loadModuleInfo(ident_t name/*, bool withAttributes*/, bool& duplicateExtensions/*, bool& duplicateAttributes*/)
      {
//         if (withAttributes)
//            /*duplicateAttributes = */loadAttributes(extModule);

         loadExtensions(name, duplicateExtensions);
