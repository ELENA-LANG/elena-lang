...
//      }
      ...
      void raiseWarning(int level, const char* message, int row, int col, ident_t sourcePath, ident_t terminal);
...
//      }
      void loadModuleInfo(_Module* extModule, bool withAttributes/*, bool& duplicateExtensions, bool& duplicateAttributes*/)
      {
         if (withAttributes)
...
//      }
      ...
      ModuleScope(_ProjectManager* project, _Module* module, _Module* debugModule, Unresolveds* forwardsUnresolved);
   };
...
//      }
   ...
   struct SourceScope : public Scope
   {
      ...
      SourceScope(ModuleScope* parent, ref_t reference, ident_t sourcePath);
   };
...
//      }
      ...
      ClassScope(ModuleScope* parent, ref_t reference, ident_t sourcePath);
   };
...
//
   bool compileDeclarations(SNode node, ModuleScope& scope, bool& repeatMode);
...
public:
   ...
   bool declareModule(ident_t sourcePath, _ProjectManager& project, _DerivationTransformer& reader, SyntaxTree& tree, ModuleInfo& moduleInfo, Unresolveds& unresolveds);
   void compileModule(_ProjectManager& project, SyntaxTree& syntaxTree, ModuleInfo& info, Unresolveds& unresolveds);
