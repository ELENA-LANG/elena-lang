...
//   ///*virtual */ref_t mapNewTerminal(SNode terminal, bool privateOne);
   ...
   virtual ref_t resolveClosure(ref_t closureMessage/*, ref_t outputRef, ExtensionMap* extensionsToExport*/, ident_t ns);

   virtual ref_t generateTemplate(ref_t reference, List<SNode>& parameters, ident_t ns/*, ExtensionMap* extensionsToExport*/);
   ...
   virtual void generateExtensoinTemplate(SyntaxTree& tree);
