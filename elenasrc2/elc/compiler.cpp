...
inline SNode newVirtualMultimethod(SNode classNode, ref_t message, LexicalType methodType, bool privateOne)
{
...
void Compiler :: injectVirtualStrongTypedMultimethod(_ModuleScope& moduleScope, SNode classNode, ref_t message, LexicalType methodType,
   ref_t resendMessage, bool privateOne)
{
   ...
   resendExpr.appendNode(lxMessage).appendNode(lxIdentifier, actionName);
...
inline bool isSingleDispatch(_ModuleScope& scope, ClassInfo& info, ref_t message, ref_t& targetMessage, bool classClassMode)
{
   if (classClassMode) {
      ClassInfo classClassInfo;
      scope.loadClassInfo(classClassInfo, info.header.classRef);

      return isSingleDispatch(scope, classClassInfo, message, targetMessage, false);
   }
...
void Compiler :: injectVirtualMultimethod(_ModuleScope& scope, SNode classNode, ref_t message, 
   LexicalType methodType, ClassInfo& info)
{
   ...
   if (isSingleDispatch(scope, info, message, resendMessage, methodType != lxClassMethod)) {
