...
//      ref_t mapTypeTemplate(SNode current);
      ...
      DerivationScope(CompilerScope* compilerScope, ident_t sourcePath, ident_t ns, IdentifierList* imports)
      {
...
//   bool isVerbAttribute(SNode terminal);
   ...
   void recognize(CompilerScope& scope, SNode node, ident_t sourcePath, ident_t ns);

   void generate(SyntaxWriter& writer, SNode node, CompilerScope& scope, ident_t sourcePath, ident_t ns,
      IdentifierList* imports, SyntaxTree& autogenerated);

public:
   void recognize(CompilerScope& scope, ident_t sourcePath, ident_t ns);

   void generate(SyntaxWriter& writer, CompilerScope& scope, ident_t sourcePath, ident_t ns, IdentifierList* imports);
