...
////      }
      DerivationScope(CompilerScope* compilerScope, ident_t sourcePath)
      {
...
//   void generateAttributeTemplate(SyntaxWriter& writer, SNode node, DerivationScope& scope, bool templateMode, int mode = 0);
   ...
   void generateSyntaxTree(SyntaxWriter& writer, SNode node, CompilerScope& scope/*, SyntaxTree& autogenerated*/, ident_t sourcePath);
