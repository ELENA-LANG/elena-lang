...
//      }
      DerivationScope(CompilerScope* compilerScope, ident_t sourcePath, MessageMap* attributes/*, IdentidierList* imports*/)
      {
...
//   void generateSymbolTree(SyntaxWriter& writer, SNode node, DerivationScope& scope/*, SNode attributes*/);
   ...
   void recognizeAttributes(SNode node, DerivationScope& scope);
...
//
//   void saveTemplate(SNode node, DerivationScope& scope, /*SNode attributes, */DerivationScope::Type type, /*SyntaxTree& autogenerated, */ref_t templateRef);
//
////   bool isVerbAttribute(SNode terminal);

   void recognizeScope(SNode node, DerivationScope& scope, int mode);
