...
//   void copyIdentifier(SyntaxWriter& writer, SNode terminal);   
   ...
   void copyOperator(SyntaxWriter& writer, SNode& node, DerivationScope& scope, int& level);
...
//   bool isVerbAttribute(SNode terminal);
   ...
   void recognize(_CompilerScope& scope, SNode node, ident_t sourcePath, ident_t ns);
...
public:
   void recognize(_CompilerScope& scope, ident_t sourcePath, ident_t ns);
