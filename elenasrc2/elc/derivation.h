...
//      }
      DerivationScope(_CompilerScope* moduleScope, ident_t sourcePath)
      {
...
//   void generateAttributeTemplate(SyntaxWriter& writer, SNode node, DerivationScope& scope, bool templateMode, int mode = 0);
   ...
   void generateSyntaxTree(SyntaxWriter& writer, SNode node, _CompilerScope& scope/*, SyntaxTree& autogenerated*/, ident_t sourcePath);
...
public:
   virtual void generateSyntaxTree(SyntaxWriter& writer, _CompilerScope& scope, ident_t sourcePath);
