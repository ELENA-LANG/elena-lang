...
//
//		This file contains the implementation of ELENA I64Assembler
//		classes.
...
void I64Assembler :: compile(TextReader* source, path_t outputPath)
{
   ...
   do {
		if (token.check("define")) {
         ...
         size_t value = token.readLongInteger(constants);
