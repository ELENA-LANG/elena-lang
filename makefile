...
all_mac_amd64: elc_mac_amd64 elenart_mac_amd64 sg_mac_amd64 og_mac_amd64 asmc_mac_amd64
...
sg_i386: 
	$(MAKE) -C elenasrc3/tools/sg/make all -f sg_i386.mak

og_i386: 
	$(MAKE) -C elenasrc3/tools/og/make all -f og_i386.mak

asmc_i386: 
	$(MAKE) -C elenasrc3/tools/asmc/make all -f asmc_i386.mak
...
elenart_i386: 
	$(MAKE) -C elenasrc3/elenart/make all -f elenart_i386.mak
...
og_amd64: 
	$(MAKE) -C elenasrc3/tools/og/make all -f og_amd64.mak

asmc_amd64: 
	$(MAKE) -C elenasrc3/tools/asmc/make all -f asmc_amd64.mak

ecv_amd64: 
	$(MAKE) -C elenasrc3/tools/ecv/codeblocks all -f ecv_amd64.mak

elenart_amd64: 
	$(MAKE) -C elenasrc3/elenart/make all -f elenart_amd64.mak
...
sg_ppc64le: 
	$(MAKE) -C elenasrc3/tools/sg/make all -f sg_ppc64le.mak

og_ppc64le: 
	$(MAKE) -C elenasrc3/tools/og/make all -f og_ppc64le.mak

asmc_ppc64le: 
	$(MAKE) -C elenasrc3/tools/asmc/make all -f asmc_ppc64le.mak

ecv_ppc64le: 
	$(MAKE) -C elenasrc3/tools/ecv/codeblocks all -f ecv_ppc64le.mak

elenart_ppc64le: 
	$(MAKE) -C elenasrc3/elenart/make all -f elenart_ppc64le.mak
...
sg_arm64: 
	$(MAKE) -C elenasrc3/tools/sg/make all -f sg_arm64.mak

og_arm64: 
	$(MAKE) -C elenasrc3/tools/og/make all -f og_arm64.mak

asmc_arm64: 
	$(MAKE) -C elenasrc3/tools/asmc/make all -f asmc_arm64.mak

ecv_arm64: 
	$(MAKE) -C elenasrc3/tools/ecv/codeblocks all -f ecv_arm64.mak

elenart_arm64: 
	$(MAKE) -C elenasrc3/elenart/make all -f elenart_arm64.mak
...
elc_mac_arm64:
	$(MAKE) -C elenasrc3/elc/make all -f elc_mac_arm64.mak

elenart_mac_amd64: 
	$(MAKE) -C elenasrc3/elenart/make all -f elenart_mac_amd64.mak

elenart_mac_arm64:
	$(MAKE) -C elenasrc3/elenart/make all -f elenart_mac_arm64.mak

elenavm_mac_arm64:
	$(MAKE) -C elenasrc3/elenavm/codeblocks all -f elenavm_mac_arm64.mak

sg_mac_amd64: 
	$(MAKE) -C elenasrc3/tools/sg/make all -f sg_mac_amd64.mak

sg_mac_arm64:
	$(MAKE) -C elenasrc3/tools/sg/make all -f sg_mac_arm64.mak

og_mac_amd64: 
	$(MAKE) -C elenasrc3/tools/og/make all -f og_mac_amd64.mak

og_mac_arm64:
	$(MAKE) -C elenasrc3/tools/og/make all -f og_mac_arm64.mak

asmc_mac_amd64: 
	$(MAKE) -C elenasrc3/tools/asmc/make all -f asmc_mac_amd64.mak

asmc_mac_arm64:
	$(MAKE) -C elenasrc3/tools/asmc/make all -f asmc_mac_arm64.mak
...
clean_mac_amd64: clean_elc_mac_amd64 clean_elenart_mac_amd64 clean_og_mac_amd64 clean_sg_mac_amd64 clean_asmc_mac_amd64
...
clean_sg_i386: 
	$(MAKE) -C elenasrc3/tools/sg/make clean -f sg_i386.mak

clean_og_i386: 
	$(MAKE) -C elenasrc3/tools/og/make clean -f og_i386.mak

clean_asmc_i386: 
	$(MAKE) -C elenasrc3/tools/asmc/make clean -f asmc_i386.mak
...
clean_elenart_i386:
	$(MAKE) -C elenasrc3/elenart/make clean -f elenart_i386.mak
...
clean_og_amd64: 
	$(MAKE) -C elenasrc3/tools/og/make clean -f og_amd64.mak

clean_og_ppc64le: 
	$(MAKE) -C elenasrc3/tools/og/make clean -f og_ppc64le.mak

clean_asmc_amd64: 
	$(MAKE) -C elenasrc3/tools/asmc/make clean -f asmc_amd64.mak

clean_ecv_amd64: 
	$(MAKE) -C elenasrc3/tools/ecv/codeblocks clean -f ecv_amd64.mak

clean_elenart_amd64:
	$(MAKE) -C elenasrc3/elenart/make clean -f elenart_amd64.mak
...
clean_sg_ppc64le: 
	$(MAKE) -C elenasrc3/tools/sg/make clean -f sg_ppc64le.mak

clean_asmc_ppc64le: 
	$(MAKE) -C elenasrc3/tools/asmc/make clean -f asmc_ppc64le.mak

clean_ecv_ppc64le: 
	$(MAKE) -C elenasrc3/tools/ecv/codeblocks clean -f ecv_ppc64le.mak

clean_elenart_ppc64le:
	$(MAKE) -C elenasrc3/elenart/make clean -f elenart_ppc64le.mak
...
clean_sg_arm64: 
	$(MAKE) -C elenasrc3/tools/sg/make clean -f sg_arm64.mak

clean_og_arm64: 
	$(MAKE) -C elenasrc3/tools/og/make clean -f og_arm64.mak

clean_asmc_arm64: 
	$(MAKE) -C elenasrc3/tools/asmc/make clean -f asmc_arm64.mak

clean_ecv_arm64: 
	$(MAKE) -C elenasrc3/tools/ecv/codeblocks clean -f ecv_arm64.mak

clean_elenart_arm64:
	$(MAKE) -C elenasrc3/elenart/make clean -f elenart_arm64.mak
...
clean_elc_mac_arm64:
	$(MAKE) -C elenasrc3/elc/make clean -f elc_mac_arm64.mak

clean_elenart_mac_amd64: 
	$(MAKE) -C elenasrc3/elenart/make clean -f elenart_mac_amd64.mak

clean_elenart_mac_arm64:
	$(MAKE) -C elenasrc3/elenart/make clean -f elenart_mac_arm64.mak

clean_elenavm_mac_arm64:
	$(MAKE) -C elenasrc3/elenavm/codeblocks clean -f elenavm_mac_arm64.mak

clean_og_mac_amd64: 
	$(MAKE) -C elenasrc3/tools/og/make clean -f og_mac_amd64.mak
...
clean_asmc_mac_amd64: 
	$(MAKE) -C elenasrc3/tools/asmc/make clean -f asmc_mac_amd64.mak
