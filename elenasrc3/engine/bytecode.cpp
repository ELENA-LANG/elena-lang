...
const char* _fnOpcodes[256] =
{
   ...
   "incude", "exclude", "assign", OPCODE_UNKNOWN, OPCODE_UNKNOWN, OPCODE_UNKNOWN, OPCODE_UNKNOWN, OPCODE_UNKNOWN,
   ...
   "save dp", "store fp", "save sp", "store sp", "xflush sp", "get", "assign i", "xrefresh sp",
