...
const char* _fnOpcodes[256] =
{
   ...
   "set", "set dp", "nlen", "xassign", "peek", "store", "xswap sp", OPCODE_UNKNOWN,
   ...
   "cmp", OPCODE_UNKNOWN, "icmp", "tst flag", OPCODE_UNKNOWN, OPCODE_UNKNOWN, OPCODE_UNKNOWN, OPCODE_UNKNOWN,
