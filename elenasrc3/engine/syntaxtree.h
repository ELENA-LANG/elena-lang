...
namespace elena_lang
{
   enum class SyntaxKey
   {
      ...
      ElseIfCondStatement     = 0x001027,
      ForStatement            = 0x001028,
      EndForStatement         = 0x001029,
      ElseCondStatement       = 0x00102A,
      ...
      IsOperation             = 0x00186F,
      TemplateArg             = 0x001070,
      Dimension               = 0x001471,
      ParameterizedPostfix    = 0x001072,
      MetaPropOperation       = 0x001873,
      ...
      IsOperand               = 0x0018A6,
      SwitchExpression        = 0x0018A7,
      SwitchValue             = 0x0018A8,
      ...
      VariadicNameArgParameter= 0x000113,
      VariadicArgParameter    = 0x000114,
