...
namespace elena_lang
{
   enum class BuildKey
   {
      ...
      ExternOp             = 0x00A3,
      AltOp                = 0x00A4,
      ShortCircuitOp       = 0x00A5,
      Switching            = 0x00A6,
      SwitchOption         = 0x00A7,
      ElseOption           = 0x00A8,
      FinalOp              = 0x00A9,
      IntBranchOp          = 0x00AA,
      IntConstBranchOp     = 0x00AB,
      RealBranchOp         = 0x00AC,
      YieldingOp           = 0x00AD,
      StackCondOp          = 0x00AE,
      YieldDispatch        = 0x00AF,
      TernaryOp            = 0x00B0,
      NilRefBranchOp       = 0x00B1,
      ExcludeTry           = 0x00B2,
      IncludeTry           = 0x00B3,
      Import               = 0x00B4,
      DictionaryOp         = 0x00B5,
      ProjectInfoOp        = 0x00B6,
      ObjOp                = 0x00B7,
      ...
      VariableInfo         = 0x00BA,
      Variable             = 0x00BB,
      VariableAddress      = 0x00BC,
      IntVariableAddress   = 0x00BD,
      LongVariableAddress  = 0x00BE,
      RealVariableAddress  = 0x00BF,
      ByteArrayAddress     = 0x00C0,
      ShortArrayAddress    = 0x00C1,
      IntArrayAddress      = 0x00C2,
      UIntVariableAddress  = 0x00C3,

      ArgumentsInfo        = 0x00C4,
      Parameter            = 0x00C5,
      IntParameterAddress  = 0x00C6,
      LongParameterAddress = 0x00C7,
      RealParameterAddress = 0x00C8,
      ParameterAddress     = 0x00C9,
      MethodName           = 0x00CA,
      ShortArrayParameter  = 0x00CB,
      ByteArrayParameter   = 0x00CC,
      IntArrayParameter    = 0x00CD,
      RealArrayParameter   = 0x00CE,
      InlineField          = 0x00CF,
