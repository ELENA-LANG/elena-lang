...
CFLAGS = -mcpu=power8 -Wall -std=c++20 -m64
RESINC = 
LIBDIR = 
LIB = 
...
$(OBJDIR_RELEASE)/__/__/__/engine/ppchelper.o: ../../../engine/ppchelper.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c ../../../engine/ppchelper.cpp -o $(OBJDIR_RELEASE)/__/__/__/engine/ppchelper.o
