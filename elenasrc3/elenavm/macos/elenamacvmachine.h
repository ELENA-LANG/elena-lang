//---------------------------------------------------------------------------
//		E L E N A   P r o j e c t:  ELENA macOS VM declaration
//
//                                             (C)2025, by Aleksey Rakov
//---------------------------------------------------------------------------

#ifndef ELENAMACVMMACHINE_H
#define ELENAMACVMMACHINE_H

#include "elenavmmachine.h"
#include "macsection.h"

namespace elena_lang
{

using PlatformImageSection = MacOSImageSection;
...
class ELENAMacOSVMMachine : public ELENAVMMachine
{
   PlatformImageSection _text, _rdata, _data, _stat, _adata, _mdata, _mbdata, _debug;
...
public:
   ...
   ELENAMacOSVMMachine(path_t configPath, PresenterBase* presenter, PlatformType platform,
