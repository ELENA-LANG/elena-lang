...
constexpr auto BuildTree_VariadicSingleDispatch_3 = "tape(open_frame()assigning 1 ()local_reference -2 ()saving_stack()varg_sop -8 (operator_id 6 ())unbox_call_message -2 (value 1 ()length -8 ()temp_var -16 ()message 1729 ())class_reference 6 ()saving_stack()argument()direct_call_op 4162 (type 13 ())loading_index -8() free_varstack() going_to_eop() close_frame()exit())reserved 4 ()reserved_n 16 ())";
