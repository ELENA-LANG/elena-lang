...
namespace elena_lang 
{
   ...
   protected:
      ...
      virtual void compileHelper(Compiler* compiler, Compiler::Namespace& ns) {}
   ...
   public:
      ...
      MethodScenarioTest()
      {
         ...
         intByRefRef = 0;
         boolTypeRef = trueRef = falseRef = 0;
      }
   };

   // --- MethodScenarioExTest

   class MethodScenarioExTest : public MethodScenarioTest
   {
   protected:
      ref_t helperRef;

      virtual SyntaxNode findHelperNode();

      void compileHelper(Compiler* compiler, Compiler::Namespace& ns) override;
