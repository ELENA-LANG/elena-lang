...
constexpr auto S_IntNumber = "class (attribute -2147467263 () attribute -2147475455 () attribute -2147479550 () nameattr (identifier \"IntNumber\" ()) field (attribute -2147471356 () attribute -2147481597 () nameattr (identifier \"_value\" ())dimension (integer \"4\" ())))";
constexpr auto S_ByteNumber = "class (attribute -2147467263 () attribute -2147475455 () attribute -2147479550 () nameattr (identifier \"ByteNumber\" ()) field (attribute -2147471356 () attribute -2147481596 () nameattr (identifier \"_value\" ())dimension (integer \"1\" ())))";
constexpr auto S_IntRefeference = "class ( attribute -2147471359 () nameattr (identifier \"IntReference\" ()) field (attribute -2147471356 () type (identifier \"IntNumber\" ()) nameattr (identifier \"_value\" ())) )";
...
constexpr auto IndexedClass_Scenario2 = "class (attribute -2147479545 ()nameattr 67 (identifier \"X\" ())method (attribute -2147459071() nameattr (identifier \"calc\" ())parameter (type (identifier \"IntNumber\" ())nameattr (identifier \"arg\" ()))returning ()))";

constexpr auto SealedByRefDeclaredInParent_Scenario1 = "class (attribute -2147479545 ()nameattr (identifier \"I\" ())method (type (identifier \"IntNumber\" ())nameattr (identifier \"foo\" ())parameter (type (identifier \"IntNumber\" ())nameattr (identifier \"n\" ())) code ())) class (attribute -2147467263 () attribute -2147479546 ()nameattr (identifier \"A\" ())parent (type (identifier \"I\" ())))";
