...
constexpr auto BuildTree1_1 = "byrefmark -8 () local_address -8 () saving_stack 1 () class_reference 4 () saving_stack () argument () direct_call_op 4098 (type 4 ()) local_address -8 () copying -4 (size 4 ())";
constexpr auto BuildTree1_2 = "byrefmark -8 () local_address -8 () saving_stack 1 () class_reference 4 () saving_stack () argument () direct_call_op 4226 (type 4 ()) local_address -8 () copying -4 (size 4 ())";
...
constexpr auto OptimizedBuildTree1_1 = "local_address -4 () saving_stack 1 () class_reference 4 () saving_stack () argument () direct_call_op 4098 (type 4 ()) local_address -4 ()";
constexpr auto OptimizedBuildTree1_2 = "local_address -4 () saving_stack 1 () class_reference 4 () saving_stack () argument () direct_call_op 4226 (type 4 ()) local_address -4 ()";
...
constexpr auto BuildTree_VariadicSingleDispatch_1 = "tape(sealed_dispatching 11 (message 6210 ()) open_frame() assigning 1 () local_reference -2 () saving_stack() varg_sop 6 (index -4 ()) unbox_call_message -2 (index 1 () length -4 () temp_var -8 () message 2241 ()) local 1 () saving_stack() argument() direct_call_op 5186 (type 5 ()) loading_index() free_varstack() close_frame() exit()) reserved 3 ()reserved_n 8 ())";
constexpr auto BuildTree_VariadicSingleDispatch_2 = "tape(open_frame() assigning 1 () class_reference 2 () direct_call_op 1056 (type 10 ()) assigning 2 () class_reference 8 () direct_call_op 1056 (type 15 ()) assigning 3 () local 2 () saving_stack() argument() call_op 2241 () assigning 4 () local 3 () saving_stack() argument() call_op 2241 () assigning 5 () terminator() saving_stack 3 () local 5 () saving_stack 2 () local 4 () saving_stack 1 () class_reference 5 () saving_stack() argument() direct_call_op 5186 (type 5 ()) local 1 () close_frame() exit()) reserved 9 ()";

constexpr auto BuildTree_VariadicSingleDispatch_4 = "tape (open_frame ()assigning 1 ()class_reference 8 ()direct_call_op 1056 (type 16 ())assigning 2 ()class_reference 9 ()direct_call_op 1056 (type 17 ())assigning 3 ()terminator ()saving_stack 3 ()local 3 ()saving_stack 2 ()local 2 ()saving_stack 1 ()class_reference 7 ()saving_stack ()argument ()direct_call_op 7234 (type 7 ())local 1 ()close_frame ()exit ())reserved 7 ())";

constexpr auto BuildTree_CallMethodWithoutTarget = "tape (open_frame ()assigning 1 ()class_reference 2 ()direct_call_op 1056 (type 6 ())assigning 2 ()local 2 ()saving_stack 1 ()local 1 ()saving_stack ()argument ()direct_call_op 6146 (type 4 ())local 1 ()close_frame ()exit ())reserved 4 ()";
constexpr auto BuildTree_CallVariadicMethodWithoutTarget = "tape(open_frame()assigning 1 ()class_reference 2 ()direct_call_op 1056 (type 8 ())assigning 2 ()class_reference 2 ()direct_call_op 1056 (type 8 ())assigning 3 ()local 2 ()saving_stack()argument()call_op 2241 ()assigning 4 ()local 3 ()saving_stack()argument()call_op 2241 ()assigning 5 ()terminator()saving_stack 3 ()local 5 ()saving_stack 2 ()local 4 ()saving_stack 1 ()local 1 ()saving_stack()argument()direct_call_op 6210 (type 4 ())local 1 ()close_frame()exit())reserved 9 ()";
constexpr auto BuildTree_CallMethodWithNil = "tape (open_frame ()assigning 1 ()nil_reference ()saving_stack 1 ()class_reference 3 ()saving_stack ()argument ()direct_call_op 3074 (type 3 ())local 1 ()close_frame ()exit ())reserved 3 ()";

constexpr auto BuildTree_LambdaCallPrivate = "tape (open_frame ()assigning 1 ()local 1 ()field ()saving_stack ()argument ()direct_call_op 6401 (type 3 ())close_frame ()exit ())reserved 2 ()";

constexpr auto BuildTree_CallMethodWithSignatureOfObject = "tape (open_frame ()assigning 1 ()int_literal 2 (value 2 ())assigning 2 ()local 2 ()saving_stack 1 ()class_reference 3 ()saving_stack ()argument ()direct_call_op 3074 (type 3 ())local 1 ()close_frame ()exit ())reserved 4 ())";
...
constexpr auto BuildTree1_1 = "byrefmark -24 () local_address -24 () saving_stack 1 () class_reference 4 () saving_stack () argument () direct_call_op 4098 (type 4 ()) local_address -24 () copying -8 (size 4 ())";
constexpr auto BuildTree1_2 = "byrefmark -24 () local_address -24 () saving_stack 1 () class_reference 4 () saving_stack () argument () direct_call_op 4226 (type 4 ()) local_address -24 () copying -8 (size 4 ())";
...
constexpr auto OptimizedBuildTree1_1 = "local_address -8 () saving_stack 1 () class_reference 4 () saving_stack () argument () direct_call_op 4098 (type 4 ()) local_address -8 ()";
constexpr auto OptimizedBuildTree1_2 = "local_address -8 () saving_stack 1 () class_reference 4 () saving_stack () argument () direct_call_op 4226 (type 4 ()) local_address -8 ()";
...
constexpr auto BuildTree_VariadicSingleDispatch_1 = "tape(sealed_dispatching 11 (message 6210 ()) open_frame() assigning 1 () local_reference -2 () saving_stack() varg_sop 6 (index -8 ()) unbox_call_message -2 (index 1 () length -8 () temp_var -24 () message 2241 ()) local 1 () saving_stack() argument() direct_call_op 5186 (type 5 ()) loading_index() free_varstack() close_frame() exit()) reserved 4 ()reserved_n 32 ())";
constexpr auto BuildTree_VariadicSingleDispatch_2 = "tape(open_frame() assigning 1 () class_reference 2 () direct_call_op 1056 (type 10 ()) assigning 2 () class_reference 8 () direct_call_op 1056 (type 15 ()) assigning 3 () local 2 () saving_stack() argument() call_op 2241 () assigning 4 () local 3 () saving_stack() argument() call_op 2241 () assigning 5 () terminator() saving_stack 3 () local 5 () saving_stack 2 () local 4 () saving_stack 1 () class_reference 5 () saving_stack() argument() direct_call_op 5186 (type 5 ()) local 1 () close_frame() exit()) reserved 10 ()";

constexpr auto BuildTree_VariadicSingleDispatch_4 = "tape (open_frame ()assigning 1 ()class_reference 8 ()direct_call_op 1056 (type 16 ())assigning 2 ()class_reference 9 ()direct_call_op 1056 (type 17 ())assigning 3 ()terminator ()saving_stack 3 ()local 3 ()saving_stack 2 ()local 2 ()saving_stack 1 ()class_reference 7 ()saving_stack ()argument ()direct_call_op 7234 (type 7 ())local 1 ()close_frame ()exit ())reserved 8 ())";

constexpr auto BuildTree_CallMethodWithoutTarget = "tape (open_frame ()assigning 1 ()class_reference 2 ()direct_call_op 1056 (type 6 ())assigning 2 ()local 2 ()saving_stack 1 ()local 1 ()saving_stack ()argument ()direct_call_op 6146 (type 4 ())local 1 ()close_frame ()exit ())reserved 4 ()";
constexpr auto BuildTree_CallVariadicMethodWithoutTarget = "tape(open_frame()assigning 1 ()class_reference 2 ()direct_call_op 1056 (type 8 ())assigning 2 ()class_reference 2 ()direct_call_op 1056 (type 8 ())assigning 3 ()local 2 ()saving_stack()argument()call_op 2241 ()assigning 4 ()local 3 ()saving_stack()argument()call_op 2241 ()assigning 5 ()terminator()saving_stack 3 ()local 5 ()saving_stack 2 ()local 4 ()saving_stack 1 ()local 1 ()saving_stack()argument()direct_call_op 6210 (type 4 ())local 1 ()close_frame()exit())reserved 10 ()";
constexpr auto BuildTree_CallMethodWithNil = "tape (open_frame ()assigning 1 ()nil_reference ()saving_stack 1 ()class_reference 3 ()saving_stack ()argument ()direct_call_op 3074 (type 3 ())local 1 ()close_frame ()exit ())reserved 4 ()";

constexpr auto BuildTree_LambdaCallPrivate = "tape (open_frame ()assigning 1 ()local 1 ()field ()saving_stack ()argument ()direct_call_op 6401 (type 3 ())close_frame ()exit ())reserved 4 ()";
