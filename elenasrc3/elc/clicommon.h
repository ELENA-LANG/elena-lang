...
public:
   ...
   virtual bool isNoTemplateReuse() = 0;
...
enum class ExpressionAttribute : pos64_t
{
   ...
   Meta                 = 0x00000000000001,
   NestedNs             = 0x00000000000002,
   Forward              = 0x00000000000004,
   WeakOp               = 0x00000000000008,
   NoTypeAllowed        = 0x00000000000010,
   Intern               = 0x00000000000020,
   Parameter            = 0x00000000000040,
   NewVariable          = 0x00000000000080,
   Local                = 0x00000000000100,
   NewOp                = 0x00000000000200,
   StrongResolved       = 0x00000000000400,
   RootSymbol           = 0x00000000000800,
   Root                 = 0x00000000001000,
   CastOp               = 0x00000000002000,
   IgnoreDuplicate      = 0x00000000004000,
   RefOp                = 0x00000000008000,
   NoPrimitives         = 0x00000000010000,
   MssgLiteral          = 0x00000000020000,
   MssgNameLiteral      = 0x00000000040000,
   Extern               = 0x00000000080000,
   Member               = 0x00000000100000,
   ProbeMode            = 0x00000000200000,
   AllowPrivateCall     = 0x00000000400000,
   InitializerScope     = 0x00000000800000,
   NestedDecl           = 0x00000001000000,
   ConstantExpr         = 0x00000002000000,
   Variadic             = 0x00000004000000,
   WithVariadicArg      = 0x00000008000000,
   RetrievingType       = 0x00000010000000,
   RetValExpected       = 0x00000020000000,
   CheckShortCircle     = 0x00000040000000,
   LookaheadExprMode    = 0x00000080000000,   
   Class                = 0x00000100000000,
   Nillable             = 0x00000200000000,
   AllowGenericSignature= 0x00000400000000,
   AsyncOp              = 0x00000800000000,
   OutRefOp             = 0x00001000000000,
   WithVariadicArgCast  = 0x00002008000000,
   DistributedForward   = 0x00004000000000,
   DynamicObject        = 0x00008000000000,
   Superior             = 0x00010000000000,
   Lookahead            = 0x00020000000000,
   NoDebugInfo          = 0x00040000000000,
   NoExtension          = 0x00080000000000,
   TryMode              = 0x00100000000000,
   GetterMode           = 0x00200000000000,
   ShortcutMode         = 0x00400000000000,
   NotNil               = 0x00800000000000,
   HeapAllocated        = 0x01000000000000,
   StackUnsafe          = 0x02000000000000,
   ReadOnly             = 0x04000000000000,
   ReferenceOp          = 0x08000000000000,
   ArgumentMode         = 0x10000000000000,
};
