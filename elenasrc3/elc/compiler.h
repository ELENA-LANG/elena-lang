...
namespace elena_lang
{
   ...
   //      irObsolete
      ...
      class Expression : public CommonHelper
      {
         ...
         bool checkDynamicSpeadOperationArg(SyntaxNode node, ObjectInfo source);
         ...
         ObjectInfo compileFinalOperation(SyntaxNode node, ExpressionAttribute mode);
   ...
   private:
      ...
      bool importMemberTemplate(Scope& scope, SyntaxNode node, ustr_t postfix, SyntaxNode& target);
      ...
      bool declareMemberPostfix(Scope& scope, SyntaxNode current, SyntaxNode& target, ustr_t postfix);
      ...
      void validateSuperClass(ClassScope& scope, SyntaxNode node) const;
